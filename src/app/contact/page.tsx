...
import { Mail, MapPin, Clock, Send, MessageCircle, Loader2, CheckCircle2, XCircle } from "lucide-react";
...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      console.error("Send email failed:", anyErr);
      setSubmitState("error");
      toast.error("Something went wrong. Please try again.", {
        duration: 4000,
        icon: <XCircle className="w-5 h-5" />,
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:sarangbhavar7721@gmail.com"
                      className="text-white hover:text-blue-400 transition-colors"
                    >
                      sarangbhavar7721@gmail.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-white">Ahilyanagar, Maharashtra, India</p>
                  </div>
                </div>
            ...
            <GlassmorphismCard className="p-8">
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <Button
                  ...
                  className="w-full bg-white text-black hover:bg-gray-200 rounded-full h-14 text-base font-semibold shadow-[0_0_30px_rgba(255,255,255,0.2)] hover:shadow-[0_0_40px_rgba(255,255,255,0.4)] transition-all hover:scale-105 cursor-pointer mt-4 disabled:opacity-80 disabled:cursor-not-allowed"
                >
                  {submitState === "sending" ? (
                  ...
                  {submitState === "sending" ? "Sending..." : null}
                  {submitState === "success" ? "Message Sent ✓" : null}
                  {submitState === "error" ? "Failed to Send" : null}
                  {submitState === "idle" ? "Send Message" : null}
                </Button>
