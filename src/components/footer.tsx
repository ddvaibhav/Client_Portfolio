...
export default function Footer() {
  ...
  const socialLinks = [
    {
      name: "YouTube",
      href: "https://www.youtube.com/channel/UC4OCgeIzb9x7wnu3__lX4Ow",
      icon: Youtube,
    },
    {
      name: "Instagram",
      href: "https://www.instagram.com/aquilyx.ai/?hl=en",
      icon: Instagram,
    },
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/in/sarang-bhavar-4abb0a247?utm_source=share_via&utm_content=profile&utm_medium=member_android",
      icon: Linkedin,
    },
    {
      name: "Twitter",
      href: "https://x.com/Aquilyxai",
      icon: Twitter,
    },
    {
      name: "Email",
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="border-t border-white/5 mt-16 pt-8 text-center">
          <p className="text-gray-500 text-sm flex items-center justify-center gap-1.5">
            ...
            <a
              href="https://www.linkedin.com/in/vaibhav-daspute-1015ab277?"
              target="_blank"
