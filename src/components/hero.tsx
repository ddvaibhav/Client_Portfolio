            ...
            <div className="relative z-10 text-center px-4 md:px-8 max-w-6xl mx-auto w-full">
                ...
                <h1 className="text-6xl md:text-8xl lg:text-9xl font-bold tracking-tighter text-white mb-8 leading-[0.9] w-full flex flex-col items-center">
                    <m.span
                        ...
                        className="relative block w-full bg-gradient-to-b from-white via-white/90 to-white/40 bg-clip-text text-transparent drop-shadow-sm pb-2"
                    >
                        {/* Shine sweep */}
                        <m.span
                            aria-hidden
                            ...
                            style={{
                                background:
                                    "linear-gradient(90deg, transparent 0%, rgba(255,255,255,0.85) 35%, rgba(255,255,255,0.95) 50%, rgba(255,255,255,0.85) 65%, transparent 100%)",
                    ...
                    <m.span
                        ...
                        className="relative block w-full text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400 pb-4 filter drop-shadow-[0_0_30px_rgba(59,130,246,0.25)]"
                    >
                        {/* Shine sweep */}
                        <m.span
                            aria-hidden
                ...
                >
                    Transforming ideas into high-quality, engaging videos — combining <span className="text-white font-medium drop-shadow-[0_0_15px_rgba(255,255,255,0.4)]">AI innovation with creative storytelling</span>.
                </m.p>
